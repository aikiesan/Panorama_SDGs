    ...
    <footer className="bg-uia-gray-light text-uia-dark border-t border-uia-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          {/* MIDDLE COLUMN: 4 Rectangular Action Buttons */}
          <div className="space-y-3">
            <a
              href="https://www.uia-architectes.org/en/about/join-us_uia/"
              target="_blank"
              rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                href="https://www.instagram.com/uia_architects/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm font-sans hover:text-uia-red transition-colors"
              >
              ...
              <a
                href="https://twitter.com/UIA_Architects"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm font-sans hover:text-uia-red transition-colors"
              >
              ...
              <a
                href="https://www.youtube.com/channel/UCGutTnNLpW0ksBkVgl8eORA"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-sm font-sans hover:text-uia-red transition-colors"
              >
